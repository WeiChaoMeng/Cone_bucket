...
<body>
<%--模态窗（添加参数）--%>
<div id="addParameter" class="model-dis"></div>

<%--模态窗（编辑参数）--%>
<div id="editParameter" class="model-dis"></div>

<%--模态窗（参数详情）--%>
<div id="parameterDetails" class="model-dis"></div>
...
<div style="height: 100%;width: 100%;background-color:#012038">
    ...
    <div class="panel-body" style="margin: 10px 20px 20px;padding: 0">
        ...
        <span id="nickname" class="query-criteria-name" style="float: left;line-height: 34px;color: #fff;width: 70px;">参数名称</span>
        <div class="query-criteria-input" style="width: 20%;float: left;">
            <input type="text" class="form-control" id="parameterName" autocomplete="off">
        </div>
                ...
                <div class="fixed-table-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 17%;background: #052846;">参数名</th>
                            <th style="width: 30%;background: #052846;">说明</th>
                            <th style="width: 10%;background: #052846;">默认值</th>
                            <th style="width: 18%;background: #052846;">备注</th>
                            <th style="width: 20%;background: #052846;">操作</th>
                        </tr>
                        </thead>
...
<script src="../../../static/js/systemManager/parameter.js"></script>
<%--分页--%>
