...
<div style="height: 100%;width: 100%;background-color:#012038">
    ...
    <div class="panel-body" style="margin: 10px 20px 20px;padding: 0">
        ...
        <span id="nickname" class="query-criteria-name" style="float: left;line-height: 34px;color: #fff;width: 70px;">用户名</span>
        ...
        <button type="button" id="btn_query" class="btn btn-primary search-btn" style="margin-right: 10px" onclick="search(1)">
            <img src="../../../static/img/search.png" style="margin-right: 3px;">查询
        </button>

    </div>

    <div id="div_table" style="padding: 0px 20px;">
                ...
                <div class="fixed-table-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 32%;background: #052846;">用户名</th>
                            <th style="width: 33%;background: #052846;">电话</th>
