...
<div style="height: 100%;width: 100%;background-color:#012038">
    ...
    <div class="panel-body" style="margin: 10px 20px 20px;padding: 0">
        ...
        <span id="nickname" class="query-criteria-name" style="float: left;line-height: 34px;color: #fff;width: 70px;">权限描述</span>
                ...
                <div class="fixed-table-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 45%;background: #052846;">权限控制地址</th>
                            <th style="width: 50%;background: #052846;">权限描述</th>
                        </tr>
                        </thead>
...
<script src="../../../static/js/systemManager/permission.js"></script>
<%--分页--%>
