                ...
                <div class="fixed-table-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th style="width: 15%;background: #052846;">锥桶编号</th>
                            <th style="width: 10%;background: #052846;">锥桶类型</th>
                            <th style="width: 20%;background: #052846;">日志内容</th>
                            <th style="width: 20%;background: #052846;">道路名称</th>
                            <th style="width: 15%;background: #052846;">开始时间</th>
                            <th style="width: 15%;background: #052846;">结束时间</th>
                        </tr>
                        </thead>
...
<script src="../../../static/js/log/coneBarrelLog.js"></script>
<%--分页--%>
