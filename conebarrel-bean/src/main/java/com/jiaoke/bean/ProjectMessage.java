...
public class ProjectMessage {
     ...
     */
    @Transient
    private List<ConeBarrelManage> coneBarrelManages;
    ...
    public List<ConeBarrelManage> getConeBarrelManages() {
        return coneBarrelManages;
    }

    public void setConeBarrelManages(List<ConeBarrelManage> coneBarrelManages) {
        this.coneBarrelManages = coneBarrelManages;
    }
